...
const UserProfile = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden mt-16">
                    ...
                    <div className="lg:w-1/4 bg-gray-50 p-6 border-r border-gray-200">
                        ...
                        <nav>
                            <ul className="space-y-2">
                                {[
                                    { text: 'Change Password', path: '/user/change-password' },
                                    ...
                                    <li key={index}>
                                        <button
                                            ...
                                            className="w-full text-left px-4 py-2 rounded-md text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        >
                                            {item.text}
                                        </button>
                                    </li>
                        ...
                        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                            <div className="px-4 py-5 sm:px-6 flex items-center space-x-6">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 max-w-2xl text-sm text-gray-500">{userProfile.email}</p>
                                </div>
                            </div>
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900">
                                            {userAddress ? (
                                                <>
                                                    ...
                                                    <p className="text-gray-600">{userAddress.area}</p>
                                                </>
                                            ) : (
